...
Tämä tietosuojaseloste koskee kaikille avointa *laaketieto.kela.fi* -verkkopalvelua osoitteessa: [laaketieto.kela.fi](https://koronamittarit.kela.fi). Tässä tietosuojaselosteessa kuvataan, miten Kela käsittelee rekisterinpitäjänä verkkopalvelun käyttäjiä koskevaa tietoa.
